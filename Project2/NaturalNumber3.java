...
public class NaturalNumber3 extends NaturalNumberSecondary {
    ...
    public NaturalNumber3(int i) {
        ...
        /*
         * If the input is zero then we don't change rep.
         */
        if (i != 0) {
            this.rep = i + "";
        }
    ...
    public final int divideBy10() {
        ...
        int reminder = 0;
        /*
         * We only deal with cases when NN is nonzero. Reminder is the last
         * digit of the rep and change the rep to the substring of last one.
         */
        if (this.rep.length() > 0) {
            reminder = Integer.parseInt(
                    String.valueOf(this.rep.charAt(this.rep.length() - 1)));
